...
library Bytes {
    ...
    function bytesToAddress(bytes memory self, uint256 _start)
        internal
        pure
        ...
        returns (uint256 r)
    {
        ...
        require(_bytes.length >= offset, "btu32");
        assembly {
            r := mload(add(_bytes, offset))
        }
    }
    ...
    function bytesToUInt160(bytes memory _bytes, uint256 _start)
        internal
        pure
        returns (uint160 r)
    {
    ...
    function bytesToHexASCIIBytes(bytes memory _input)
        internal
        pure
            ...
            for {
                ...
                mstore(
                    ...
                    shl(
                        0xf8,
                        shr(
                            mul(shr(0x04, curr_input_byte), 0x08),
                            0x66656463626139383736353433323130
                        )
                    )
                )
                mstore(
                    ...
                    shl(
                        0xf8,
                        shr(
                            mul(and(0x0f, curr_input_byte), 0x08),
                            0x66656463626139383736353433323130
                        )
                    )
                )
